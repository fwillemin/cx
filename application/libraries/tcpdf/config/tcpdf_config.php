 ...
 * Document author.
 */
define('PDF_AUTHOR', 'Xanthellis');

/**
 * Header title.
 */
define('PDF_HEADER_TITLE', 'CX document');

/**
 * Header description string.
 */
define('PDF_HEADER_STRING', "par CX, logiciel de gestion de point de vente carrelage, parquet, moquette et revetements de sol srtatifiés.");
