...
$autoload['libraries'] = array('session', 'database', 'form_validation', 'cart', 'cxwork', 'email', 'ion_auth',
    ...
    'avoir', 'avoirligne', 'avoirtva', 'cloture', 'acompte',
    'caisse', 'remise', 'token', 'own'
);
...
$autoload['helper'] = array('url', 'html', 'form', 'text', 'file', 'email');
...
$autoload['model'] = array(
    ...
    'model_clotures' => 'managerClotures',
    'model_acomptes' => 'managerAcomptes'
);
